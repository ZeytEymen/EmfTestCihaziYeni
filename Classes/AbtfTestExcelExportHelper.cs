...
{
    public class AbtfTestExcelExportHelper
    {
        ...
        public AbtfTestExcelExportHelper(string productFullName, string productSerialNo, string testOperator, string companyName, System.Data.DataTable testValues)
        {
